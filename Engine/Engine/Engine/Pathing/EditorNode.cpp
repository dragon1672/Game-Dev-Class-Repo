...
#include <Engine\Pathing\EditorNodeConnection.h>
...
bool EditorNode::doesRayHit(Ray& ray) {
	return doesRayHit(ray,this->pos,1);
}
bool EditorNode::doesRayHit(Ray& ray, glm::vec3 orgin, float radius) {
	glm::vec3 raytoCircle_C = orgin - ray.origin;

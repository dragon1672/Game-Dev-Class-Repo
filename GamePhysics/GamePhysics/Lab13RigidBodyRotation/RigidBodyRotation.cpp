...
void RigidBodyRotation::reset(float lowRange) {
	float bodyRadius = 5;
...
void RigidBodyRotation::resetRandom() {
	reset(.2);
}
void RigidBodyRotation::resetCircle() {
	reset(1);
}
...
void RigidBodyRotation::newFrame() {
